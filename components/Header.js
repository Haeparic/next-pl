...
const Header = () => {
  return (
    <>
      <Head>
        <title>프론트엔드 엄준식 포트폴리오</title>
        <meta name="decription" content="프론트엔드 개발자 엄준식 포트폴리오" />
        <meta name="keyword" content="React.js, Next.js, portfolio, 엄준식" />
        ...
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          <Link href="/">
            <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
              <span className="ml-3 text-xl">FrontEnd UJS</span>
            </a>
          </Link>
